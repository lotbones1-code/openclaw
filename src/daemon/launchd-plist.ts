...
// Keep launchd from SIGKILLing the gateway before the default 120s graceful
// drain plus shutdown cleanup can finish.
export const LAUNCH_AGENT_EXIT_TIMEOUT_SECONDS = 150;
